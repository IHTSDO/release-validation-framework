...
public class UAnBn extends Grammar{
    ...
    public static Grammar getInstance(){
        if(factoryInstance == null){
            factoryInstance = new UAnBn(getRules(), getUdts(), getOpcodes());
        }
    ...
    public enum UdtNames{
        /** id = <code>0</code>, name = <code>"u_anbn"</code> */
        U_ANBN(0, "u_anbn", false);
        private String name;
        private int id;
    ...
    // private
    private static UAnBn factoryInstance = null;
    private UAnBn(Rule[] rules, Udt[] udts, Opcode[] opcodes){
    ...
    public static void display(PrintStream out){
        out.println(";");
        out.println("; examples.anbn.UAnBn");
        out.println(";");
        out.println("AnBn = u_anbn");
    }
}
