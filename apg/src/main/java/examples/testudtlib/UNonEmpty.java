...
public class UNonEmpty extends Grammar{
    ...
    public static Grammar getInstance(){
        if(factoryInstance == null){
            factoryInstance = new UNonEmpty(getRules(), getUdts(), getOpcodes());
        }
    ...
    public enum UdtNames{
        /** id = <code>0</code>, name = <code>"u_udt"</code> */
        U_UDT(0, "u_udt", false);
        private String name;
        private int id;
    ...
    // private
    private static UNonEmpty factoryInstance = null;
    private UNonEmpty(Rule[] rules, Udt[] udts, Opcode[] opcodes){
    ...
    public static void display(PrintStream out){
        out.println(";");
        out.println("; examples.testudtlib.UNonEmpty");
        out.println(";");
        out.println("udt = u_udt");
    }
}
