...
public class Utilities {
	 ...
	 * @throws NullPointerException {@link File}
	 * @throws FileNotFoundException {@link File}
	 * @throws IOException {@link File}
	...
	/**
	 * Return a {@link File} object for the named file.
	 * @param dir directory to find the file in.
	 * @param filename name of the file to find.
	 * @return the {@link File} object or null if not the file could not be found
	 */
	...
	/**
	 * Displays detailed information on {@link File}.
	 * @param out the output device to display on.
