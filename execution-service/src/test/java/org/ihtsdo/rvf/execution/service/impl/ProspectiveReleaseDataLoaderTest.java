...
public class ProspectiveReleaseDataLoaderTest {
	...
	ProspectiveReleaseDataLoader dataLoader;
	...
	public void setUp() {
		...
		dataLoader = new ProspectiveReleaseDataLoader(validationConfig, releaseDataManager);
	...
	public void testConstructProspectiveVersionWithRF2DeltaOnly() throws BusinessServiceException {
		List<String> filesLoaded = dataLoader.loadProspectiveDeltaWithPreviousSnapshotIntoDB(prospectiveVersion);
