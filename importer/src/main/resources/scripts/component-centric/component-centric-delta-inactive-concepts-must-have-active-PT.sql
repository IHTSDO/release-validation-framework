...
concat('Inactive concept (', c.id, '|', d1.term,'|) missing active Preferred Term in one or more English dialects.') 
...
AND ( NOT EXISTS (
		...
		AND l.active = 1
		AND d2.active = 1
		AND d2.typeid = 900000000000013009 -- |Synonym (core metadata concept)|
