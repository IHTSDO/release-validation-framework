/********************************************************************************
	component-centric-full-mrcm-refset-validate-concept-is-valid-descendant-proc.sql

	Defines a procedure to validate whether a concept is a descendant of specified concepts in MRCM Refsets Full

********************************************************************************/
drop procedure if exists validateConceptIdIsValidDescendantsInMRCMRefsetFull_procedure;
create procedure validateConceptIdIsValidDescendantsInMRCMRefsetFull_procedure(runId bigint, assertionId varchar(36), tableName varchar(255), columnName varchar(255), refsetName varchar(255), rootConceptIds varchar(1024), expression varchar(4000))
begin
