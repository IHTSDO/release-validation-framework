...
/******************************************************************************** 
file-centric-snapshot-ch-fr-translated-concepts.sql

	Assertion:
	Newly added active concept has one active preferred term in the Swiss French language refset.
...
insert into qa_result (runid, assertionuuid, concept_id, details)
	select  	
		...
		'<ASSERTIONUUID>',
		a.id,
		concat('Concept: id=',a.id, ': is added in a recent international release but has no active preferred term in the Swiss French language refset')
