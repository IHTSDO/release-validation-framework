...
/******************************************************************************** 
	file-centric-snapshot-be-french-translated-concepts.sql

	Assertion:
	Newly added active concept has one active preferred term in the Belgian French language refset.
...
insert into qa_result (runid, assertionuuid, concept_id, details)
	select  	
		...
		'<ASSERTIONUUID>',
		a.id,
		concat('Concept: id=',a.id, ': is added recently in the international release but has no active preferred term in the Belgian French language refset')
