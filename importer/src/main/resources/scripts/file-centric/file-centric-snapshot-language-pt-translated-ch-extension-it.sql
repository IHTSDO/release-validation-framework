...
/******************************************************************************** 
	file-centric-snapshot-language-pt-translated-ch-extension-it

	Assertion:
	Every active concept from the international release is recommended to have one active preferred term in the Swiss Italian language refset.
