...
/******************************************************************************** 
	file-centric-snapshot-ee-translated-concepts.sql

	Assertion:
	Newly added active concept has one active preferred term in the Estonian language refset.
...
insert into qa_result (runid, assertionuuid, concept_id, details)
	select  	
		...
		'<ASSERTIONUUID>',
		a.id,
		concat('Concept: id=',a.id, ': is added recently in the international release but has no active preferred term in the Estonian language refset')
