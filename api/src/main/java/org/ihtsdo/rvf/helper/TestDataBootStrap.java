...
//				+ "group by b.source_id_column_name " + "having count(*) = 1;";
//		template.replace("curr_concept_table_name", "curr_concept_s");
//		template.replace("curr_stated_relationship_table_name",
...
//		executableTest = (org.ihtsdo.rvf.entity.Test) entityService
//				.create(executableTest);
