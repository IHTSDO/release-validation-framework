...
public class JMSBrokerManager {
	...
	public JMSBrokerManager(String url, Boolean isAutoScalingEnabled)
			throws Exception {
		...
		logger.info("Auto scaling is enabled:" + isAutoScalingEnabled
				+ " and the queue broker url is:" + brokerUrl);
